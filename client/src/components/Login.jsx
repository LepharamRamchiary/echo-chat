...
// Success/Dashboard Component (simple example)
    ...
    <div className="min-h-screen flex items-center justify-center p-4 bg-gradient-to-br from-green-50 to-blue-50">
      <div className="bg-white rounded-3xl shadow-2xl w-full max-w-md p-8 text-center">
        ...
        <div className="bg-gray-50 rounded-xl p-4 mb-6 text-left">
          ...
          <p className="text-sm text-gray-600">Phone: +91 {user.phoneNumber}</p>
          {user.fullname && <p className="text-sm text-gray-600">Name: {user.fullname}</p>}
          <p className="text-sm text-gray-600">Verified: {user.isVerified ? 'Yes' : 'No'}</p>
          <p className="text-sm text-gray-600">ID: {user._id}</p>
        </div>
        
        <button
          onClick={onLogout}
          className="w-full bg-gradient-to-r from-red-500 to-pink-500 text-white py-3 rounded-xl font-semibold hover:from-red-600 hover:to-pink-600 focus:outline-none focus:ring-2 focus:ring-red-500 focus:ring-offset-2 transition-all duration-200"
        >
          Logout
        </button>
      </div>
...
// Main App Component that handles the authentication flow
// const App = () => {
...
//           <p className="text-gray-600 mb-6">Registration component would go here</p>
//           <button
//             onClick={handleBackToLogin}
//             className="w-full bg-gradient-to-r from-gray-500 to-gray-600 text-white py-3 rounded-xl font-semibold hover:from-gray-600 hover:to-gray-700 transition-all duration-200"
//           >
//             Back to Login
//           </button>
//         </div>
